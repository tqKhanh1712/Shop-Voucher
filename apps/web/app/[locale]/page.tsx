      ...
      >
        <div className="flex flex-col gap-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-6 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <div>
            ...
            <h1
              id="catalog-title"
              className="mt-2 font-black tracking-tight text-slate-900 dark:text-slate-100"
            >
              {tHome('title')}
            </h1>
          ...
          <Link
            href="/for-customers"
            className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl border border-orange-200 bg-orange-50 px-5 py-2.5 text-sm font-extrabold text-primary transition hover:border-orange-300 hover:bg-orange-100 dark:bg-orange-500/10 dark:border-orange-500/20"
          >
            {tHome('howItWorks')}
